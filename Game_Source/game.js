function ToggleFullScreen() {
		...
		var buildUrl = "Build";
		var loaderUrl = buildUrl + "/Real_Flight_Simulator.loader.js";
		var config = {
        dataUrl: buildUrl + "/Real_Flight_Simulator.data",
        frameworkUrl: buildUrl + "/Real_Flight_Simulator.framework.js",
        codeUrl: buildUrl + "/Real_Flight_Simulator.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "Gamebol",
        productName: "Real Flight Simulator",
        productVersion: "1.0",
      };
